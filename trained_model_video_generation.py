...
def parse_args():
    parser = argparse.ArgumentParser(description='Choose trained model to create videos of')

    # Path to model state to load from trained models
    parser.add_argument('--state-dict', type=str, help='Enter path to model state dict')
...
def run():
    ...
    champ.policy_network.load_state_dict(torch.load(args.state_dict))
